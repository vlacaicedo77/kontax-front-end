...
@Component({
  selector: 'app-cambiar-clave-caducada-interno',
  templateUrl: './cambiar-clave-caducada-interno.component.html',
  styleUrls: []
})
export class CambiarClaveCaducadaInternoComponent implements OnInit {
