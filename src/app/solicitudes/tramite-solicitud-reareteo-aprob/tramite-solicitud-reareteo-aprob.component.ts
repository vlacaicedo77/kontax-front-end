...
@Component({
  selector: 'app-tramite-solicitud-reareteo-aprob',
  templateUrl: './tramite-solicitud-reareteo-aprob.component.html',
  styleUrls: []
})
export class TramiteSolicitudReareteoAprobComponent implements OnInit {
