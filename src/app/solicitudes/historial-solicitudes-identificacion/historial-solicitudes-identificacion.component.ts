...
@Component({
  selector: 'app-historial-solicitudes-identificacion',
  templateUrl: './historial-solicitudes-identificacion.component.html',
  styleUrls: []
})
export class HistorialSolicitudesIdentificacionComponent implements OnInit {
  ...
  .subscribe( (resp: any) => {
   ...
   buscarDetalleSolicitud(solicitud){
    ...
    this._solicitudService.consultarDetalleSolicitud(this.solicitudSeleccionada['id_solicitudes_identificadores'])
  .subscribe( (resp: any) => {
    if ( resp.estado === 'OK')  
    {
      //console.log (resp);
