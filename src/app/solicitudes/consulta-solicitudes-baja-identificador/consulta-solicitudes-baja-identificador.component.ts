...
@Component({
  selector: 'app-consulta-solicitudes-baja-identificador',
  templateUrl: './consulta-solicitudes-baja-identificador.component.html',
  styleUrls: []
})
export class ConsultaSolicitudesBajaIdentificadorComponent implements OnInit {
