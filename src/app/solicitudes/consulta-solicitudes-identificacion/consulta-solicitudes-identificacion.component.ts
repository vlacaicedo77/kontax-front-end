...
@Component({
  selector: 'app-consulta-solicitudes-identificacion',
  templateUrl: './consulta-solicitudes-identificacion.component.html',
  styleUrls: []
})
export class ConsultaSolicitudesIdentificacionComponent implements OnInit {
