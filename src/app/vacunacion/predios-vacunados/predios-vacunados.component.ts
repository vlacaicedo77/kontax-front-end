...
@Component({
  selector: 'app-predios-vacunados',
  templateUrl: './predios-vacunados.component.html',
  styleUrls: ['./predios-vacunados.component.css']
})
export class PrediosVacunadosComponent implements OnInit {
  ...
  limpiarDatos(){
    ...
    this.formularioDetalleCertificado.controls.fecha_carga.setValue('');
    ...
    this.formularioDetalleCertificado.controls.codigo_sitio.setValue('');
  }
   ...
   cambioCertificado(){
    ...
    this.listaCertificadosVacunacion.forEach( (itemCertificado: CertificadoVacunacion) => {
      if ( Number(this.formularioBusqueda.value.certificado) === Number(itemCertificado.idCertificadoVacunacion) ){
        ...
        this.formularioDetalleCertificado.controls.predio.setValue(certificado.nombrePredio);
        ...
        this.formularioDetalleCertificado.controls.fecha_carga.setValue(certificado.fechaCreacion);
        ...
        this.formularioDetalleCertificado.controls.codigo_sitio.setValue(certificado.codigoSitioCuv);
      }
    });
