...
@Component({
  selector: 'app-crear-usuario-externo-consulta',
  templateUrl: './crear-usuario-externo-consulta.component.html',
  styleUrls: ['./crear-usuario-externo-consulta.component.css']
})
export class CrearUsuarioExternoConsultaComponent implements OnInit {
  ...
  crearUsuario()
  {
    ...
    if(this.formulario.value.inputNumeroIdentificacion == null || this.formulario.value.inputNumeroIdentificacion == ""){
      ...
      mensaje += "<li>Ingrese User Name</li>";
    }
    ...
    Swal.fire({
      ...
      usuario.idPais = 19;
      usuario.numeroIdentificacion = this.formulario.value.inputNumeroIdentificacion.toUpperCase();
      usuario.nombres = this.formulario.value.inputApellidos.toUpperCase() +' '+ this.formulario.value.inputNombres.toUpperCase();
